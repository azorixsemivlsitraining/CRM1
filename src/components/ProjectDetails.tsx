...
const [paymentMode, setPaymentMode] = useState(() => {
  ...
  // Payment receipt preview modal state
  const {
...
// ...
// Preview and download payment receipt as PDF
...
const handleDownloadReceiptFromPreview = () => {
  if (!receiptPreviewUrl) return;
  const link = document.createElement('a');
  link.href = receiptPreviewUrl;
  link.download = `Payment_Receipt_${Date.now()}.pdf`;
...
return (
  <Box p={6} maxW="5xl" mx="auto">
    ...
    <Modal isOpen={isReceiptPreviewOpen} onClose={onReceiptPreviewClose} size="full">
      <ModalOverlay />
      <ModalContent>
        <ModalHeader>
          <Flex justify="space-between" align="center">
            <Text>Payment Receipt Preview</Text>
            <HStack spacing={2}>
              <Button colorScheme="blue" onClick={handleDownloadReceiptFromPreview}>
                Download PDF
              </Button>
              <ModalCloseButton />
            </HStack>
        ...
        <ModalBody>
          {receiptPreviewUrl ? (
            ...
            <Box textAlign="center" py={10}>
              ...
              <Text mt={4}>Generating receipt...</Text>
            </Box>
          )}
        </ModalBody>
      </ModalContent>
