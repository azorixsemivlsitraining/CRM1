                                      ...
                                      onClick={async () => {
                                        if (window.confirm('Are you sure you want to cancel this project?')) {
                                          try {
                                            ...
                                            toast({ title: 'Success', description: 'Project cancelled successfully', status: 'success' });
                                            fetchProjects();
                                          } catch (e: any) {
                                            toast({ title: 'Error', description: e.message || 'Failed to cancel project', status: 'error' });
                                          }
                                        }
                                      }}
                                    >
