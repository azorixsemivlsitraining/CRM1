                                  ...
                                  onClick={async () => {
                                    ...
                                    try {
                                      const { error } = await supabase
                                        ...
                                        .eq('id', project.id);
                                      if (error) throw error;
                                      toast({ title: 'Project cancelled', status: 'success', duration: 2000, isClosable: true });
                                      fetchChitoorProjects();
                                    } catch (e) {
                                      toast({ title: 'Failed to cancel', description: formatSupabaseError(e), status: 'error', duration: 3000, isClosable: true });
                                    }
                                  }}
                                >
                                  Mark Cancelled
