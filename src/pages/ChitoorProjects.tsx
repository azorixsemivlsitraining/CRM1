        ...
        <div className="lg:col-span-2 space-y-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-11 pr-4 py-3 border border-slate-200 rounded-2xl bg-slate-50 focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:bg-white focus:border-blue-500 transition-all font-medium text-slate-700"
              value={query}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:col-span-2">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="block w-full px-4 py-3 border border-slate-200 rounded-2xl bg-slate-50 focus:outline-none focus:ring-4 focus:ring-blue-500/10 transition-all text-sm font-medium"
              value={mandalFilter}
